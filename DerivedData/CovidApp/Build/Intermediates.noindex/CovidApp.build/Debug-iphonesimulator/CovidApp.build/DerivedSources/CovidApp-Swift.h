...
#ifndef COVIDAPP_SWIFT_H
#define COVIDAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CovidApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8CovidApp11AppDelegate")
...
SWIFT_CLASS("_TtC8CovidApp13SceneDelegate")
...
SWIFT_CLASS("_TtC8CovidApp14ViewController")
